const fs = require('fs');
// Normalize to LF
let html = fs.readFileSync('c:/IA/LUMI/index.html', 'utf8').replace(/\r\n/g, '\n');
...
const bentoTarget = `      <div class="theme-card fade-up fade-up-delay-3" data-category="meninas">
...
// Convert back to CRLF before saving just in case
html = html.replace(/\n/g, '\r\n');
